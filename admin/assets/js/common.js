...
function showAlertDlg(message, button_type, callback, str_btn = "OK") {
    swal({
...
function showConfirmDlg(message, callback, close_flag, cancel_callback, str_confirm = "OK", str_cancel = "Cancel") {
